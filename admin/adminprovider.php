...
-->
                            ...
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" placeholder="Categoría" name="providerAddres" required="" maxlength="70" data-toggle="tooltip" data-placement="top" title="Escribe la categoría">
                                <span class="highlight"></span>
                                <span class="bar"></span>
...
<!--
                            ...
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" placeholder="Teléfono del departamento" name="providerPhone" pattern="[0-9+]{5,20}" maxlength="20" data-toggle="tooltip" data-placement="top" title="Solo números y símbolo +">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Teléfono</label>
                            </div>
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" placeholder="Responsable de atención" name="providerResponsible"  maxlength="50" data-toggle="tooltip" data-placement="top" title="Responsable de atención">
                                <span class="highlight"></span>
                                <span class="bar"></span>
