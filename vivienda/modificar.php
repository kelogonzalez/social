		...
		<div class="container">
			...
			<form class="form-horizontal" method="POST" action="update.php" autocomplete="off">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="number" class="form-control" id="cedula" name="cedula" placeholder="Cédula" value="<?php echo $row['cedula']; ?>" >
					</div>
				</div>
				...
				<div class="form-group">
					<label for="direccion" class="col-sm-2 control-label">Teléfono</label>
					<div class="col-sm-10">
